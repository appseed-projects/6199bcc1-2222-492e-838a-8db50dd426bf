...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-19 14:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6199bcc1-2222-492e-838a-8db50dd426bf.git
$ cd 6199bcc1-2222-492e-838a-8db50dd426bf
```
